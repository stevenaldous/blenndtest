<div class="card testimonial testimonial--<?php acf_text('testimonials_layout_cards'); ?> text-dark">
	...
	<div class="testimonial__content">
		...
		<?php the_content(); ?>
		<a href="<?php the_permalink(); ?>" class="btn-text text-uppercase font-weight-bold">Read More</a>
	</div>
</div>
